...
console.log(`   - Total de receitas filtradas para hoje: ${receitasFiltradasHoje.length}`);
...
console.log("   - Veja se lancamentos e lancamentosFiltrados estão sendo atualizados");
...
window.limparDadosDebug = function() {
  ...
  const lancamentosLimpos = lancamentos.filter(l => !l.id.startsWith("debug-") && !l.id.startsWith("teste-"));
