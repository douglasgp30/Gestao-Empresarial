...
const verificarFiltros = (receitaTeste) => {
  ...
  console.log(
    ...
    passaNoFiltroData && passaNoFiltroTipo,
  );
...
const verificarEstadoAtual = () => {
  ...
  ultimasReceitas.forEach((r, i) => {
    console.log(
      `     ${i + 1}. ID: ${r.id}, Valor: R$ ${r.valor}, Data: ${new Date(r.data).toLocaleString()}`,
    );
  });
};
...
console.log(
  "   6. Se não aparecer, abra as ferramentas do React e verifique o estado do CaixaContext",
);
