        ...
        conta.id === id 
          ? { 
              ...
              status: dadosAtualizados.dataVencimento 
                ? getStatusConta(dadosAtualizados.dataVencimento, dadosAtualizados.status || conta.status)
                : conta.status
            }
          : conta
      )
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setContas(prev => 
        prev.map(conta => ({
          ...conta,
          status: conta.status === 'paga' ? 'paga' : getStatusConta(conta.dataVencimento, conta.status)
        }))
      );
