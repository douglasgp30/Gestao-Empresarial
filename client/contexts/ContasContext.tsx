...
export function ContasProvider({ children }: { children: ReactNode }) {
  ...
  const carregarContas = async () => {
    try {
      ...
      console.log("[ContasContext] Response da API:", response);
      console.log("[ContasContext] Dados das contas:", contasData);
      ...
      console.error("🔥 [DEBUG] Contas formatadas e setadas:", contasFormatadas.length, contasFormatadas);
    } catch (error) {
