...
interface EntidadesContextType {
  ...
  adicionarDescricao: (descricao: Omit<Descricao, 'id' | 'dataCriacao'>) => void;
  editarDescricao: (id: string, descricao: Partial<Descricao>) => void;
  excluirDescricao: (id: string) => void;

  // Formas de Pagamento
  formasPagamento: FormaPagamento[];
  adicionarFormaPagamento: (forma: Omit<FormaPagamento, 'id' | 'dataCriacao'>) => void;
  ...
  adicionarFornecedor: (fornecedor: Omit<Fornecedor, 'id' | 'dataCriacao'>) => void;
...
export function EntidadesProvider({ children }: { children: ReactNode }) {
  ...
  const [formasPagamento, setFormasPagamento] = useState<FormaPagamento[]>(mockFormasPagamento);
