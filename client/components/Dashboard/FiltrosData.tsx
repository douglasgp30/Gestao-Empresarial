  ...
  const isPeriodoAtivo = (
    ...
    switch (tipo) {
      case "mesAtual": {
        ...
        return (
          filtros.dataInicio.toDateString() === inicioMes.toDateString() &&
      ...
      case "ultimos7dias": {
        ...
        return (
          filtros.dataInicio.toDateString() === inicio7dias.toDateString() &&
      ...
      case "estaemana": {
        ...
        return (
          filtros.dataInicio.toDateString() === inicioSemana.toDateString() &&
          filtros.dataFim.toDateString() === hoje.toDateString()
        );
      }
      case "ultimos30dias": {
        ...
        return (
          filtros.dataInicio.toDateString() === inicio30dias.toDateString() &&
          filtros.dataFim.toDateString() === hoje.toDateString()
        );
      }
      default:
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Período selecionado:{" "}
          {formatDateRange(filtros.dataInicio, filtros.dataFim)}
        </CardDescription>
      </CardHeader>
