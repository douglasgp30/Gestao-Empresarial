      ...
      <CardContent className="space-y-4">
        <div className="p-3 bg-green-50 border border-green-200 rounded">
          ...
          <div className="text-sm text-green-700">
            Os Filtros Avançados agora carregam exatamente os mesmos dados da
            tela de lançamento.
          </div>
        </div>
        ...
        <div className="p-3 bg-blue-50 border border-blue-200 rounded">
          ...
          <div className="text-sm text-blue-700 space-y-1">
            <div>
              1. Abra o <strong>Caixa</strong> e clique em{" "}
              <strong>Filtros Avançados</strong>
            </div>
            <div>
              2. Verifique se todos os campos mostram as opções corretas:
            </div>
            <div className="ml-4">
              • <strong>Técnico:</strong> João Silva, Maria Santos, Ana
              Oliveira, etc.
            </div>
            <div className="ml-4">
              • <strong>Forma Pagamento:</strong> Dinheiro, PIX, Cartão de
              Débito, etc.
            </div>
            <div className="ml-4">
            ...
            <div>
              3. Confirme que o período padrão é <strong>hoje</strong> (não o
              mês inteiro)
            </div>
          </div>
        </div>
        ...
        <div className="p-3 bg-yellow-50 border border-yellow-200 rounded">
          ...
          <div className="text-sm text-yellow-700 space-y-1">
            <div>
              • Os dados são os <strong>mesmos</strong> usados na tela de
              lançamento
            </div>
            <div>
              • O campo <strong>Número da Nota</strong> permanece em branco
              (como solicitado)
            </div>
            <div>• Todos os outros campos mostram "Todos/Todas" por padrão</div>
            <div>
              • Os dados ficam salvos no banco e persistem entre sessões
            </div>
          </div>
        </div>
      </CardContent>
