      ...
      <CardContent className="space-y-4">
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge
                  variant={dados.campanhas.total > 0 ? "default" : "secondary"}
                >
                  {dados.campanhas.total}
                </Badge>
              </div>
              <div className="text-xs text-gray-500">
                {dados.campanhas.fonte}
              </div>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge
                  variant={
                    dados.formasPagamento.total > 0 ? "default" : "secondary"
                  }
                >
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge
                  variant={
                    dados.tecnicosArray.total > 0 ? "default" : "secondary"
                  }
                >
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge
                  variant={
                    dados.tecnicosCombinados.total > 0 ? "default" : "secondary"
                  }
                >
              ...
              <div className="text-xs text-gray-500">
                {dados.tecnicosCombinados.fonte}
              </div>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-sm space-y-1">
              ...
              <div>
                getTecnicos(): {dados.tecnicosCombinados.total} técnicos
              </div>
              <div
                className={`font-medium ${dados.tecnicosArray.total === dados.tecnicosCombinados.total ? "text-green-600" : "text-orange-600"}`}
              >
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-sm space-y-1">
              <div>
                • Filtros devem usar getTecnicos() ao invés do array tecnicos
              </div>
              <div>
                • Verificar se campanhas estão sendo carregadas corretamente
              </div>
