        ...
        {data && (
          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="space-y-2">
              <p><strong>Total de itens:</strong> {data.data?.length || 0}</p>
                  ...
                  <div>
                    ...
                    <ul className="ml-4 list-disc">
                      {data.data
                        ...
                        .map((cat: any) => (
                          <li key={cat.id}>{cat.nome} (ID: {cat.id})</li>
                        ))}
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="ml-4 list-disc">
                      {data.data
                        ...
                        .map((desc: any) => (
                          <li key={desc.id}>{desc.nome} ({desc.categoria}) - ID: {desc.id}</li>
                        ))}
                    </ul>
                  </div>
                </>
            ...
            <details className="mt-4">
              <summary className="cursor-pointer font-semibold">🔍 Dados completos (JSON)</summary>
