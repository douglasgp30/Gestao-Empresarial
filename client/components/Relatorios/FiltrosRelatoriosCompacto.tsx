...
import { Filter, ChevronDown, X, BarChart3, Download, Users, DollarSign } from "lucide-react";
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              ...
              <div className="space-y-1">
                ...
                <Select
                  value={filtros.tipo || ""}
                  onValueChange={(value) =>
                    setFiltros({ ...filtros, tipo: value === "" ? undefined : value as any })
                  }
                >
              ...
              <div className="space-y-1">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFiltros({ ...filtros, formaPagamento: value === "" ? undefined : value })
                  }
                >
                  <SelectTrigger className="h-8 text-sm">
              ...
              <div className="space-y-1">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFiltros({ ...filtros, tecnico: value === "" ? undefined : value })
                  }
                >
                  <SelectTrigger className="h-8 text-sm">
              ...
              <div className="space-y-1">
                ...
                <Select
                  value={filtros.setor || ""}
                  onValueChange={(value) =>
                    setFiltros({ ...filtros, setor: value === "" ? undefined : value })
                  }
                >
                  <SelectTrigger className="h-8 text-sm">
                    <SelectValue placeholder="Todos" />
              ...
              <div className="space-y-1">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFiltros({ ...filtros, status: value === "" ? undefined : value })
                  }
                >
                  <SelectTrigger className="h-8 text-sm">
                    <SelectValue placeholder="Todos" />
