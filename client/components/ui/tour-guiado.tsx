...
const etapasDoTour: EtapaTour[] = [
  {
    ...
    descricao: 'Vamos fazer um tour rápido para te ajudar a conhecer as principais funcionalidades do sistema.',
    icone: <CheckCircle className="w-6 h-6 text-green-600" />
  },
  {
    id: 'dashboard',
    titulo: 'Dashboard Principal',
    descricao: 'Aqui você tem uma visão geral do seu negócio: receitas, despesas, agendamentos e muito mais.',
  ...
  },
  {
    ...
    descricao: 'Registre todas as receitas e despesas da sua empresa. Mantenha o controle financeiro em dia!',
  ...
  },
  {
    ...
    descricao: 'Cadastre técnicos e funcionários, configure permissões e controle comissões.',
  ...
  },
  {
    id: 'agendamentos',
    titulo: 'Agendamentos',
    descricao: 'Organize a agenda da sua empresa e nunca perca um compromisso importante.',
  ...
  },
  {
    ...
    descricao: 'Personalize o sistema, faça backups e acesse os logs de auditoria.',
  ...
  },
  {
    ...
    descricao: 'Agora você já conhece as principais funcionalidades. Explore o sistema e comece a gerenciar seu negócio!',
    icone: <CheckCircle className="w-6 h-6 text-green-600" />
  }
];
      ...
      >
        ...
        <CardContent className="space-y-4">
          ...
          <div className="text-center pt-2 border-t">
            <Button variant="link" size="sm" onClick={pularTour} className="text-xs">
