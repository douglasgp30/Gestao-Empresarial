  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <strong>✅ TAMANHOS PEQUENOS:</strong><br/>
        • Switch Pequeno: 32x16px<br/>
        • Switch Mínimo: 28x14px<br/>
        • Bolinha: 12px e 10px respectivamente<br/>
        • SEM frameworks - CSS inline puro<br/>
