...
export function DemoSwitchesPequenos() {
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={sectionStyle}>
        <h3 style={{ marginBottom: "15px", color: "#495057" }}>
          Checkboxes HTML Nativos (32x16px):
        </h3>
      ...
      >
        ...
        >
          <li>
            📏 <strong>Tamanho:</strong> 32x16px (bem pequeno)
          </li>
          <li>
            ⚫ <strong>Bolinha:</strong> 12x12px (proporcional)
          </li>
          <li>
            🎨 <strong>Design:</strong> Simples e limpo
          </li>
          <li>
            ⚡ <strong>Performance:</strong> CSS inline, sem dependências
          </li>
          <li>
