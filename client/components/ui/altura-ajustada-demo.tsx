    ...
    <Card className="w-full max-w-lg mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="bg-green-50 p-3 rounded text-xs text-green-800 border border-green-200">
          ...
          <br />• <strong>Altura:</strong> 16px → 12px
          <br />• <strong>Largura:</strong> 28px (mantida)
          <br />• <strong>Bolinha:</strong> 12px → 10px
          <br />• <strong>Visual:</strong> Menos "circular", mais proporcional
          <br />• <strong>Border-radius:</strong> 16px → 12px (proporcional)
        </div>

        <div className="text-xs text-gray-500 text-center">
          Agora os switches têm altura igual ao tamanho da bolinha,
          <br />
