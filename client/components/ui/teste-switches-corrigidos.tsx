    ...
    <Card className="w-full max-w-lg mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
          <h4 className="font-medium text-blue-800 mb-3">Switches em funcionamento:</h4>
          ...
          <div className="space-y-3">
            <div className="flex items-center">
              ...
              <Label htmlFor="test1" className="cursor-pointer text-sm">
                Switch nativo - {native1 ? 'LIGADO (azul)' : 'DESLIGADO (cinza)'}
              </Label>
            </div>
            ...
            <div className="flex items-center">
              ...
              <Label htmlFor="test2" className="cursor-pointer text-sm">
                Switch nativo - {native2 ? 'LIGADO (azul)' : 'DESLIGADO (cinza)'}
              </Label>
            </div>
        ...
        <div className="bg-green-50 p-3 rounded text-sm text-green-800 border border-green-200">
          ...
          • <strong>Círculo externo:</strong> Altura reduzida para 10px (menos redondo)<br/>
          • <strong>Bolinha interna:</strong> Mantida em 8px (proporcional)<br/>
          • <strong>Visual:</strong> Formato oval em vez de circular<br/>
          • <strong>Funcionalidade:</strong> 100% preservada
        </div>

        <div className="text-xs text-gray-500 text-center">
          O círculo externo (fundo) agora está menos redondo,<br/>
