...
async function createSampleData() {
  ...
  try {
    ...
    const additionalData = [
      ...
      { nome: 'Venda de Software', tipo: 'receita', tipoItem: 'descricao', categoria: 'Produtos' },
      { nome: 'Licenças', tipo: 'receita', tipoItem: 'descricao', categoria: 'Produtos' },
      
      // Descriptions for Serviços (receita) - additional
      { nome: 'Suporte Técnico', tipo: 'receita', tipoItem: 'descricao', categoria: 'Serviços' },
      { nome: 'Treinamento', tipo: 'receita', tipoItem: 'descricao', categoria: 'Serviços' },
      
      // Descriptions for Impostos (despesa)
      { nome: 'IRPJ', tipo: 'despesa', tipoItem: 'descricao', categoria: 'Impostos' },
      { nome: 'CSLL', tipo: 'despesa', tipoItem: 'descricao', categoria: 'Impostos' },
      
      // Descriptions for Salários (despesa)
      { nome: 'Salário CLT', tipo: 'despesa', tipoItem: 'descricao', categoria: 'Salários' },
      { nome: 'Pro-labore', tipo: 'despesa', tipoItem: 'descricao', categoria: 'Salários' },
      
      // Descriptions for Operacional (despesa) - additional
      { nome: 'Aluguel', tipo: 'despesa', tipoItem: 'descricao', categoria: 'Operacional' },
      { nome: 'Energia Elétrica', tipo: 'despesa', tipoItem: 'descricao', categoria: 'Operacional' },
      
      // Descriptions for Marketing (despesa) - additional
      { nome: 'Google Ads', tipo: 'despesa', tipoItem: 'descricao', categoria: 'Marketing' },
      { nome: 'Facebook Ads', tipo: 'despesa', tipoItem: 'descricao', categoria: 'Marketing' }
    ];
    ...
    console.log(`✅ Created ${additionalData.length} additional categories and descriptions`);
